// recovery/scheduler/schedulerRunNow.js
...
const result = spawnSync('schtasks.exe', ['/Run', '/TN', TASK_NAME], {
  cwd: ROOT_DIR,
  shell: false,
  encoding: 'utf8',
});
...
writeHistory({ event: 'RUN_NOW', taskName: TASK_NAME, ok, exitCode: result.status });
