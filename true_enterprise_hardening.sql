...
-- DropIndex
DROP INDEX "public"."ProductType_branchId_globalProductTypeId_normalizedName_key";

-- DropIndex
DROP INDEX "public"."ProductType_branchId_globalProductTypeId_slug_key";

-- AlterTable
ALTER TABLE "public"."CustomerProfile" ALTER COLUMN "paymentTerms" DROP DEFAULT,
ALTER COLUMN "subdistrictCode" SET DATA TYPE TEXT,
ALTER COLUMN "depositBalance_v2" SET DATA TYPE DECIMAL(12,2),
ALTER COLUMN "outstandingDebt_v2" SET DATA TYPE DECIMAL(12,2);

-- AlterTable
ALTER TABLE "public"."District" ADD COLUMN     "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
