...
-- DropForeignKey
ALTER TABLE "public"."WarrantyClaim" DROP CONSTRAINT "WarrantyClaim_saleReturnItemId_fkey";
...
-- DropIndex
DROP INDEX "public"."WarrantyClaim_saleReturnItemId_idx";
...
-- AlterTable
ALTER TABLE "public"."WarrantyClaim" DROP COLUMN "saleReturnItemId",
