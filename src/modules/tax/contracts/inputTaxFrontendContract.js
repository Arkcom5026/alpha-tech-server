...
const endpoints = Object.freeze([
  ...
  endpoint({ id: 'tax-period-transition', method: 'POST', path: `${TAX_PERIOD_BASE}/periods/:taxPeriodId/:action`, request: Object.freeze({ body: ['branchId', 'occurredAt?'], params: ['taxPeriodId', 'action=close|lock|submit|reopen'] }), response: 'TaxPeriod transition result with replayed', capability: 'ADMINISTER_PERIOD', replay: 'MUTATION_REPLAY_SAFE', concurrency: Object.freeze({ compareAndSet: true }), errors: Object.freeze(['TAX_PERIOD_STALE_VERSION']) }),
