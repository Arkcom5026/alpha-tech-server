...
router.get('/output-tax/overview', controller.getOutputTaxOverview);
router.get('/output-tax/period-closing-plan', controller.getOutputTaxPeriodClosingPlan);
router.get('/output-tax/period-readiness', controller.getOutputTaxPeriodReadiness);
router.get('/output-tax/period-report', controller.getOutputTaxPeriodReport);
router.post('/output-tax/periods', controller.createOutputTaxPeriod);
router.get('/output-tax/periods', controller.listOutputTaxPeriods);
router.get('/output-tax/periods/:outputTaxPeriodId/timeline', controller.getOutputTaxPeriodTimeline);
router.get('/output-tax/periods/:outputTaxPeriodId', controller.getOutputTaxPeriod);
router.post('/output-tax/periods/:outputTaxPeriodId/request-close', controller.requestCloseOutputTaxPeriod);
router.post('/output-tax/periods/:outputTaxPeriodId/close', controller.closeOutputTaxPeriod);
router.post('/output-tax/periods/:outputTaxPeriodId/reopen', controller.reopenOutputTaxPeriod);
