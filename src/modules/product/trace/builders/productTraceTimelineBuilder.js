...
const buildProductTraceTimeline = ({ stockItem, procurement, sales, returns, claims, repairs, permissions }) => {
  ...
  if (stockItem.receivedAt) events.push(createProductTraceTimelineEvent({
    ...
    title: 'à¸£à¸±à¸šà¸ªà¸´à¸™à¸„à¹‰à¸²à¹€à¸‚à¹‰à¸²à¸ªà¸•à¹‡à¸­à¸',
    ...
    status: procurement?.receipt?.statusReceipt || 'IN_STOCK',
  ...
  if (stockItem.scannedAt) events.push(createProductTraceTimelineEvent({
    ...
    title: 'à¸šà¸±à¸™à¸—à¸¶à¸à¸ªà¸´à¸™à¸„à¹‰à¸²à¹€à¸‚à¹‰à¸²à¸£à¸°à¸šà¸š',
  ...
  for (const cycle of sales?.cycles || (sales ? [sales] : [])) {
    events.push(createProductTraceTimelineEvent({
      ...
      category: ProductTraceEventCategory.SALES, occurredAt: cycle.sale.soldAt, title: 'à¸‚à¸²à¸¢à¸ªà¸´à¸™à¸„à¹‰à¸²',
  ...
  for (const item of returns || []) {
    ...
    events.push(createProductTraceTimelineEvent({
      ...
      title: 'à¸£à¸±à¸šà¸„à¸·à¸™à¸ªà¸´à¸™à¸„à¹‰à¸²à¹à¸¥à¸°à¸„à¸·à¸™à¹€à¸‚à¹‰à¸²à¸žà¸£à¹‰à¸­à¸¡à¸‚à¸²à¸¢', description: item.reason || saleReturn.reason || null,
    ...
    for (const refund of item.refundTransactions || []) events.push(createProductTraceTimelineEvent({
      ...
      title: 'à¸„à¸·à¸™à¹€à¸‡à¸´à¸™à¹ƒà¸«à¹‰à¸¥à¸¹à¸à¸„à¹‰à¸²', document: { type: 'SALE_RETURN', id: saleReturn.id, code: saleReturn.code },
  ...
  for (const claim of claims || []) events.push(createProductTraceTimelineEvent({
    ...
    category: ProductTraceEventCategory.CLAIM, occurredAt: claim.createdAt, title: 'à¹€à¸›à¸´à¸”à¹€à¸„à¸¥à¸¡à¸ªà¸´à¸™à¸„à¹‰à¸²',
  ...
  for (const repair of repairs || []) {
    events.push(createProductTraceTimelineEvent({
      ...
      category: ProductTraceEventCategory.REPAIR, occurredAt: repair.createdAt, title: 'à¸£à¸±à¸šà¸ªà¸´à¸™à¸„à¹‰à¸²à¹€à¸‚à¹‰à¸²à¸‹à¹ˆà¸­à¸¡',
