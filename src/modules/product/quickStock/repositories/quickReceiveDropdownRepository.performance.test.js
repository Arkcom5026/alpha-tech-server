...
const { QuickReceiveDropdownRepository } = require('./quickReceiveDropdownRepository')
...
const logs = []
const calls = { branchFindFirst: 0, productTypeFindMany: 0 }
...
const prisma = {
  ...
  productType: {
    findMany: async () => {
      ...
      return [
        { id: 11, name: 'Ink', active: true, branchId: 2, normalizedName: 'ink', globalProductTypeId: 101, globalProductType: { id: 101, name: 'Ink', categoryId: 7 } },
        { id: 12, name: 'Ink', active: true, branchId: 2, normalizedName: 'ink', globalProductTypeId: 101, globalProductType: { id: 101, name: 'Ink', categoryId: 7 } },
      ]
    },
  },
}
