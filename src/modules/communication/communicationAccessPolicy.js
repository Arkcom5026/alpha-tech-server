...
const getCommunicationCapabilities = (actor = {}) => {
  ...
  return Object.freeze({
    viewCommunication:
      ...
      hasResidualBusinessCapability(actor, RESIDUAL_BUSINESS_CAPABILITIES.COMMUNICATION_OPERATE),
    manageCommunicationProfiles:
      authenticatedEmployee &&
      hasResidualBusinessCapability(actor, RESIDUAL_BUSINESS_CAPABILITIES.COMMUNICATION_PROFILE_MANAGE),
  });
};
