...
const getCommunicationCapabilities = (actor = {}) => {
  ...
  return Object.freeze({
    viewCommunication: authenticatedEmployee && hasResidualBusinessCapability(
      actor,
      RESIDUAL_BUSINESS_CAPABILITIES.COMMUNICATION_ACCESS,
    ),
    manageCommunicationProfiles: authenticatedEmployee && hasResidualBusinessCapability(
      actor,
      RESIDUAL_BUSINESS_CAPABILITIES.COMMUNICATION_PROFILE_MANAGE,
    ),
  });
};
