...
const getCommunicationCapabilities = (actor = {}) => {
  ...
  return Object.freeze({
    viewCommunication: authenticatedEmployee && hasCapability(actor, POSITION_CAPABILITIES.COMMUNICATION_USE),
    manageCommunicationProfiles: authenticatedEmployee && hasCapability(actor, POSITION_CAPABILITIES.COMMUNICATION_PROFILE_MANAGE),
  });
};
