const POSITION_CAPABILITIES = Object.freeze({
  ...
  PROCUREMENT_SUPPLIER_ADVANCE_READ: 'procurement.supplier-advance.read',
  PROCUREMENT_SUPPLIER_ADVANCE_MANAGE: 'procurement.supplier-advance.manage',
  PROCUREMENT_SUPPLIER_ADVANCE_CONTROL: 'procurement.supplier-advance.control',
  PROCUREMENT_SUPPLIER_PAYABLE_READ: 'procurement.supplier-payable.read',
  PROCUREMENT_SUPPLIER_PAYABLE_MANAGE: 'procurement.supplier-payable.manage',
  PROCUREMENT_SUPPLIER_PAYABLE_CONTROL: 'procurement.supplier-payable.control',
  ...
  COMMUNICATION_USE: 'communication.use',
  ...
  QUOTATION_LIFECYCLE: 'quotation.lifecycle',
  ...
  TAX_WITHHOLDING_READ: 'tax.withholding.read',
  TAX_WITHHOLDING_TREATMENT: 'tax.withholding.treatment',
...
const SUPPLIER_ADVANCE_CAPABILITIES = Object.freeze([
  POSITION_CAPABILITIES.PROCUREMENT_SUPPLIER_ADVANCE_READ,
  POSITION_CAPABILITIES.PROCUREMENT_SUPPLIER_ADVANCE_MANAGE,
  POSITION_CAPABILITIES.PROCUREMENT_SUPPLIER_ADVANCE_CONTROL,
]);

const SUPPLIER_PAYABLE_CAPABILITIES = Object.freeze([
  POSITION_CAPABILITIES.PROCUREMENT_SUPPLIER_PAYABLE_READ,
  POSITION_CAPABILITIES.PROCUREMENT_SUPPLIER_PAYABLE_MANAGE,
  POSITION_CAPABILITIES.PROCUREMENT_SUPPLIER_PAYABLE_CONTROL,
]);

const BANK_CAPABILITIES = Object.freeze([
  POSITION_CAPABILITIES.FINANCE_BANK_READ,
  POSITION_CAPABILITIES.FINANCE_BANK_MANAGE,
  POSITION_CAPABILITIES.FINANCE_BANK_DELETE,
]);
...
const OPERATIONAL_EMPLOYEE_CAPABILITIES = Object.freeze([
...
const OPERATIONAL_ELEVATED_CAPABILITIES = Object.freeze([
...
const QUOTATION_CAPABILITIES = Object.freeze([
  POSITION_CAPABILITIES.QUOTATION_READ,
  POSITION_CAPABILITIES.QUOTATION_MANAGE,
  POSITION_CAPABILITIES.QUOTATION_ISSUE,
  POSITION_CAPABILITIES.QUOTATION_LIFECYCLE,
]);
...
const TAX_ACCOUNTING_OFFICE_CAPABILITIES = Object.freeze([
  POSITION_CAPABILITIES.TAX_ACCOUNTING_OFFICE_READ,
]);
...
const TAX_WITHHOLDING_CAPABILITIES = Object.freeze([
  POSITION_CAPABILITIES.TAX_WITHHOLDING_READ,
  POSITION_CAPABILITIES.TAX_WITHHOLDING_TREATMENT,
  POSITION_CAPABILITIES.TAX_WITHHOLDING_CERTIFICATE_ISSUE,
  POSITION_CAPABILITIES.TAX_WITHHOLDING_FILING_PREPARE,
...
const legacyCapabilitiesForRole = (role) => {
  ...
  if (normalized === 'OWNER' || normalized === 'MANAGER') {
    return [
      ...
      ...BANK_CAPABILITIES,
      ...FINANCE_RECEIVABLE_CAPABILITIES,
      ...OPERATIONAL_EMPLOYEE_CAPABILITIES,
      ...OPERATIONAL_ELEVATED_CAPABILITIES,
      ...SALES_CAPABILITIES,
      ...QUOTATION_CAPABILITIES,
...
module.exports = {
  ...
  INVENTORY_CAPABILITIES,
  PROCUREMENT_CAPABILITIES,
  SUPPLIER_ADVANCE_CAPABILITIES,
  SUPPLIER_PAYABLE_CAPABILITIES,
  BANK_CAPABILITIES,
  FINANCE_RECEIVABLE_CAPABILITIES,
  OPERATIONAL_EMPLOYEE_CAPABILITIES,
  OPERATIONAL_ELEVATED_CAPABILITIES,
