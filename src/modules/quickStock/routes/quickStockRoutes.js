...
if (typeof handleQuickEnroll !== 'function') {
  throw new Error('[quickStockRoutes] handleQuickEnroll is not a function — check src/modules/quickStock/controllers/quickStockController.js export')
}
...
if (typeof handleQuickStockInAllInOne !== 'function') {
  throw new Error('[quickStockRoutes] handleQuickStockInAllInOne (quickStockInAllInOne) is not a function — check src/modules/quickStock/controllers/quickStockController.js export')
}
