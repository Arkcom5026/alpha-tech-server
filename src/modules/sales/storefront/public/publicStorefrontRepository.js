  ...
  return {
    ...
    fulfillment: {
      ...
      delivery: {
        ...
        fixedFee: store.deliveryEnabled ? money(store.fixedDeliveryFee) : null,
        serviceAreaMode: store.deliveryEnabled ? store.serviceAreaMode : null,
        maxDistanceKm: store.deliveryEnabled ? money(store.maxDeliveryDistanceKm) : null,
    ...
    products: products.map((product) => {
      ...
      return {
        ...
        warrantyDays: product.warrantyDays == null ? null : Number(product.warrantyDays),
        availability: {
