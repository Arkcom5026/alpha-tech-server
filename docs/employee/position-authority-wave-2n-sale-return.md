...
The server implementation was re-applied on top of the current `main` after the parallel `credit-sale-preinvoice-return-e2e` work was merged. That parallel credit-return authority remains intact; Wave 2N only adds Position-first access and deducted-refund approval authority.
