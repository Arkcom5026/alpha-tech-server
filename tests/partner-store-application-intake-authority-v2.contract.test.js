...
assert.ok(intake.includes("eventType: 'SUBMITTED'"))
assert.ok(intake.includes("resultingStatus: 'PENDING'"))
assert.ok(intake.includes('partnerStoreApplicationEvent.create'))
