...
assert.ok(verifier.includes("deliveryFeeMode: 'FREE'"))
assert.ok(verifier.includes("serviceAreaMode: 'ADMIN_AREAS'"))
assert.ok(verifier.includes('deliveryFeeMode: null'))
assert.ok(verifier.includes("serviceAreaMode: 'PICKUP_ONLY'"))
