...
assertIncludes(provider, 'generateChallengeSecret', 'OTP verifier must have per-challenge secret material');
...
assertIncludes(service, 'encodeOtpVerifier', 'Challenge secret and verifier hash must be encoded durably');
assertIncludes(service, 'decodeOtpVerifier', 'OTP verification must recover the challenge verifier contract');
