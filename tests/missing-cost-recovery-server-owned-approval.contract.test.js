...
assert.match(controller, /requireMissingCostRecoveryExecutionAuthority/);
assert.match(controller, /ALLOW_MISSING_COST_RECOVERY_EXECUTION/);
assert.match(controller, /ADMIN/);
assert.match(controller, /SUPERADMIN/);
